...
inline mat4 mat4::operator*(const mat4& m)
{
	return mat4
	{
		...
		n[8] * m.n[0] + n[9] * m.n[4] + n[10] * m.n[8] + n[11] * m.n[12],  n[8] * m.n[1] + n[9] * m.n[5] + n[10] * m.n[9] + n[11] * m.n[13],  n[8] * m.n[2] + n[9] * m.n[6] + n[10] * m.n[10] + n[11] * m.n[14],  n[8] * m.n[3] + n[9] * m.n[7] + n[10] * m.n[11] + n[11] * m.n[15],
